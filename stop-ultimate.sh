...
echo "🛑 Остановка Telegram-бота (ультимативная версия)"
echo "==============================================="

# Остановка бота
if [ -f "bot-ultimate.pid" ]; then
    BOT_PID=$(cat bot-ultimate.pid)
...
if [ -f "logs/bot-ultimate.log" ]; then
    echo "   - Строк в логе: $(wc -l < logs/bot-ultimate.log)"
    echo "   - Размер лога: $(du -h logs/bot-ultimate.log | cut -f1)"
fi
