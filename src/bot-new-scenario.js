...
2. Описание состояния (2-3 предложения, простыми словами)
3. Символы (2 пункта: объект → значение)

ВАЖНО: Пиши ясно и понятно, без канцеляризмов. Используй короткие предложения, говори прямо. Избегай слов-паразитов. Будь эмоциональным и человечным.
...
3. Символы (2 пункта: объект → значение)
4. Итог с ключевыми смыслами всех карт
5. Одно простое практическое действие
...
SYMBOLS: [символы: объект → значение, каждый с новой строки]
SUMMARY: [итог с ключевыми смыслами всех карт]
PRACTICE: [одно простое действие]`;
