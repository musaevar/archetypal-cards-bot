        ...
        switch (session.state) {
            case DIALOG_STATES.IDLE:
                if (text.toLowerCase().includes('готов')) {
                    ...
                    await bot.sendMessage(chatId, `Какой у тебя запрос?  
Что ты чувствуешь?  
Что происходит в твоей жизни?  

Опиши своё состояние одним-двумя словами или короткой фразой.  
Например: "я потерял путь", "устал", "злюсь", "мне тревожно", "страшно".`);
...
// Запуск бота
console.log('🤖 Telegram-бот "Архетипические карты" запущен в ультимативной версии!');
console.log('🔧 Функции: профессиональные промпты, КПТ рекомендации, улучшенный UX');
