...
Опиши свои ощущения от увиденного.`);
            ...
            case DIALOG_STATES.WAITING_FOR_CARD2_RESPONSE:
                ...
                await bot.sendMessage(chatId, `Теперь проведу психологический анализ твоих ответов... 🧠`);
...
${analysisData.recommendations}`);
                ...
                await bot.sendMessage(chatId, `Теперь создаю третью карту — мост между твоим состоянием и ресурсом... 🌉`);
                
                // Генерация третьей карты
...
// Запуск бота
console.log('🤖 Telegram-бот "Архетипические карты" запущен с полным сценарием!');
console.log('🔧 Функции: 3 карты, психологический анализ, рекомендации');
