...
echo "🚀 Запуск Telegram-бота с кнопками и улучшенной генерацией"
echo "========================================================"
...
echo "🚀 Запуск улучшенного бота с кнопками..."
nohup node src/bot-buttons-improved.js > logs/bot-buttons-improved.log 2>&1 &
BOT_PID=$!

# Сохранение PID
echo $BOT_PID > bot-buttons-improved.pid

echo "✅ Бот запущен (PID: $BOT_PID)"
echo "📋 Логи: tail -f logs/bot-buttons-improved.log"
echo "🛑 Остановка: kill $BOT_PID или ./stop-buttons-improved.sh"
...
if kill -0 $BOT_PID 2>/dev/null; then
    ...
    echo ""
    echo "🎯 Улучшенная версия включает:"
    echo "   🔘 Inline-кнопки для удобства"
    echo "   🎨 Улучшенная генерация изображений (из bot-with-loaders.js)"
    ...
    echo "❌ Бот не запустился. Проверьте логи: cat logs/bot-buttons-improved.log"
    exit 1
fi

echo ""
echo "🎉 Улучшенный бот с кнопками запущен!"
echo "💡 Для остановки используйте: ./stop-buttons-improved.sh"
