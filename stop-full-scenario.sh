...
echo "🛑 Остановка Telegram-бота с полным сценарием"
echo "============================================"

# Остановка бота
if [ -f "bot-full.pid" ]; then
    BOT_PID=$(cat bot-full.pid)
...
if [ -f "logs/bot-full.log" ]; then
    echo "   - Строк в логе: $(wc -l < logs/bot-full.log)"
    echo "   - Размер лога: $(du -h logs/bot-full.log | cut -f1)"
fi
