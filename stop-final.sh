...
echo "🛑 Остановка Telegram-бота (финальная версия)"
echo "==========================================="

# Остановка бота
if [ -f "bot-final.pid" ]; then
    BOT_PID=$(cat bot-final.pid)
...
if [ -f "logs/bot-final.log" ]; then
    echo "   - Строк в логе: $(wc -l < logs/bot-final.log)"
    echo "   - Размер лога: $(du -h logs/bot-final.log | cut -f1)"
fi
