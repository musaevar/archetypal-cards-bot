...
echo "🛑 Остановка Telegram-бота с GPT-4.1 и редактурой"
echo "==============================================="

# Остановка бота
if [ -f "bot-gpt41-editing.pid" ]; then
    BOT_PID=$(cat bot-gpt41-editing.pid)
...
if [ -f "logs/bot-gpt41-editing.log" ]; then
    echo "   - Строк в логе: $(wc -l < logs/bot-gpt41-editing.log)"
    echo "   - Размер лога: $(du -h logs/bot-gpt41-editing.log | cut -f1)"
fi
